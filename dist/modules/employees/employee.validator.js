...
exports.createEmployeeSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        advanceDeductionMode: zod_1.z
            .nativeEnum(client_1.AdvanceDeductionMode)
            .default(client_1.AdvanceDeductionMode.AUTO),
...
exports.updateEmployeeSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        advanceDeductionMode: zod_1.z.nativeEnum(client_1.AdvanceDeductionMode).optional(),
        profileImage: zod_1.z.string().url().optional(),
    }),
});
