...
exports.assertSalaryHistoryNotLocked = exports.assertAdvanceCycleNotLocked = exports.assertAttendanceRequestNotLocked = exports.assertAttendanceApprovalNotLocked = exports.assertAttendanceNotLocked = exports.findActivePayrollForCycle = exports.isAttendanceDateLockedByPayroll = exports.findActivePayrollForDate = void 0;
        ...
        where: {
            ...
            OR: [
                ...
                ...(date.getUTCDay() === 0
                    ? [
                        {
                            salaryType: client_1.SalaryType.WEEKLY,
                            periodStart: nextDay,
                        },
                    ]
                    : []),
...
const isAttendanceDateLockedByPayroll = (payroll, date) => {
    if (payroll.periodStart <= date && payroll.periodEnd >= date) {
        return true;
    }
    if (payroll.salaryType !== client_1.SalaryType.WEEKLY || date.getUTCDay() !== 0) {
        return false;
    }
    const nextDay = new Date(date);
    nextDay.setUTCDate(nextDay.getUTCDate() + 1);
...
exports.isAttendanceDateLockedByPayroll = isAttendanceDateLockedByPayroll;
...
const assertAttendanceRequestNotLocked = async (employeeId, date) => {
    const payroll = await (0, exports.findActivePayrollForDate)(employeeId, date);
    if (payroll) {
        throw new app_error_1.AppError("Cannot submit attendance request because payroll already exists for this attendance period. Cancel or recalculate payroll first.", 400);
    }
};
exports.assertAttendanceRequestNotLocked = assertAttendanceRequestNotLocked;
